...
import { 
  DataContextType as ExternalDataContextType, 
  Place, 
  City, 
  State,
  Review, 
...
// Use the external DataContextType shape so components and types/index.ts stay in sync,
// but keep this file as the implementation source of truth.
type DataContextType = ExternalDataContextType & {
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchInitialData = async () => {
    // Mark global loading while the initial data is being fetched
    ...
    try {
      ...
      const error = err instanceof Error ? err : new Error('Failed to load initial data');
