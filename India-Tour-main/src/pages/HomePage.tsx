...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Safety Integration Strip */}
      <section className="py-16 bg-gradient-to-r from-orange-50 via-white to-blue-50 border-y border-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-start lg:items-center gap-10">
          <div className="flex-1 max-w-xl">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              Travel safely with India Tour Safety
            </h2>
            <p className="text-base text-gray-600 mb-4">
              Create a Safety Digital ID, share your live location when you choose, and access an emergency-ready
              dashboard that works together with local responders.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                to="/safety/digital-id"
                className="inline-flex items-center px-5 py-2.5 rounded-full bg-orange-600 text-white text-sm font-semibold shadow-sm hover:bg-orange-700 transition-colors"
              >
              ...
              <Link
                to="/safety/dashboard"
                className="inline-flex items-center px-5 py-2.5 rounded-full border border-orange-300 text-sm font-semibold text-orange-700 bg-white hover:bg-orange-50 transition-colors"
              >
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
            <Link
              to="/safety/digital-id"
              className="rounded-2xl bg-white shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow"
            >
              <p className="text-xs font-semibold text-orange-600 mb-1">Safety Digital ID</p>
              <p className="text-sm text-gray-700">
                Store key identity and emergency details securely to speed up support when it matters.
              </p>
            </Link>
            <Link
              to="/safety/dashboard"
              className="rounded-2xl bg-white shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow"
            >
              <p className="text-xs font-semibold text-orange-600 mb-1">Tourist Dashboard</p>
              <p className="text-sm text-gray-700">
                Panic button, recent alerts, and live safety score in a single simple view.
              </p>
            </Link>
            <Link
              to="/safety/admin"
              className="rounded-2xl bg-white shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow"
            >
              <p className="text-xs font-semibold text-orange-600 mb-1">Admin & Police View</p>
              <p className="text-sm text-gray-700">
                Command-center style panel for authorities to monitor incidents and support tourists.
              </p>
            </Link>
          </div>
        </div>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            const fullState = states.find((s) => s.id === state.id);
                            if (fullState) {
                              addState(fullState);
                            }
                          }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-2xl hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Smart Safety Monitoring</h3>
              <p className="text-gray-600 mb-3">
                Use the Safety Digital ID and tourist dashboard to stay visible to helpers during emergencies and
                receive risk-aware alerts while travelling.
              </p>
              <Link
                to="/safety"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 max-w-3xl mx-auto">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Indian Cultural Celebrations</h3>
                <p className="text-gray-600">
                  Immerse yourself in music, dance, arts, and cultural performances that bring India's traditions to life.
                </p>
              </div>
            </div>
          </div>
